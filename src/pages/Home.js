...
const Home = () => {
  ...
  const bannerTexts = [
    t('WE LOVE LOVE LETTERS', 'WE LOVE LOVE LETTERS'),
    t('VER COLECÇÃO', 'VIEW COLLECTION')
  ];

  useEffect(() => {
    const interval = setInterval(() => {
      setBannerText((prev) => (prev + 1) % bannerTexts.length);
    }, 3000);
  ...
  return (
    <div className="min-h-screen pt-24 md:pt-32" data-testid="home-page">
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        {/* Animated Banner */}
        <Link to="/shop" className="absolute top-0 left-0 right-0 overflow-hidden">
          <motion.div
            className="bg-accent/90 py-3 md:py-4 cursor-pointer hover:bg-accent transition-colors"
          ...
          >
            <div className="relative h-8 md:h-10 flex items-center justify-center">
              <AnimatePresence mode="wait">
                ...
                >
                  <span className="font-courier font-black text-lg md:text-2xl tracking-widest text-white uppercase">
        ...
        <div className="relative w-full px-4 md:px-8 lg:px-16 py-12 z-10 mt-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2">
        ...
        >
          <h2 className="font-courier font-bold text-2xl md:text-3xl uppercase mb-6">
      ...
      {/* Final CTA */}
      <section className="py-16 md:py-24 px-4 md:px-8 lg:px-16 text-center bg-secondary/10">
